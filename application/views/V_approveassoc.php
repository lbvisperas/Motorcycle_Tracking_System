								...
								<?php
									foreach ($franchise as $row)
									{
										echo "<tr>";
											...
											echo "<td>";
												echo "<a href='https://tricyclefranchisingsorsogon.online/ph/index.php/mycontroller/C_assocup/$row[association_id]' type = 'button' role = 'button' class='btn btn-block btn-success '><span class='glyphicon glyphicon-thumbs-up'></span> Approve</a>";
												echo "<a href='hhttps://tricyclefranchisingsorsogon.online/ph/index.php/mycontroller/C_assocdown/$row[association_id]' type = 'button' role = 'button' class='btn btn-block btn-warning '><span class='glyphicon glyphicon-thumbs-down'></span> Disapprove</a>";
