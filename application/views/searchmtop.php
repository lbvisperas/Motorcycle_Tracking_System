		...
		<div class="col-sm-12">
			<div class="panel panel-primary shadow text-center">
				<div class="panel-heading">
					<div class="row">
						<div class="col-sm-6">
							<h4 class="pull-left ">Issuance</h4>
						</div>
					</div>
				</div>
						...
						<table class="table table-stripped table-condensed table-hover" style="margin-bottom: 6px" id="advance-table">
							...
							<?php
								foreach ($franchise as $row)
								{
										...
										if ($row['mtop_issuance'] === "Not Issued" and $row['franchise_approval'] === "Approved")
										{
											echo "<tr>";
										...
										echo "<td style='padding-top:12px'>$var</td>";
											...
											echo "<td>";
											echo "<a href='https://tricyclefranchisingsorsogon.online/ph/index.php/mycontroller/issuemtop/$row[franchise_id]' type = 'button' role = 'button' class='btn btn-success'><span class='glyphicon glyphicon-file'></span> Issue MTOP</a>";
											echo "</td>";
											echo "</tr>";
										}
								}
