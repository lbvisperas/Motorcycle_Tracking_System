		...
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="panel panel-primary shadow text-center">
					<div class="panel-heading"><b class="">Manage Associations</b></div>
								...
								<?php
									foreach ($franchise as $row)
									{
										echo "<tr>";
											...
											echo "<td>";
												echo "<a href='https://tricyclefranchisingsorsogon.online/ph/index.php/mycontroller/assocedit/$row[association_id]' type = 'button' role = 'button' class='btn btn-success '><span class='glyphicon glyphicon-edit'></span> Edit</a>";
												echo "<a href='https://tricyclefranchisingsorsogon.online/ph/index.php/mycontroller/deleteassoc/$row[association_id]' type = 'button' role = 'button' class='btn btn-danger '><span class='glyphicon glyphicon-trash'></span> Delete</a>";
											echo "</td>";
										echo "</tr>";
									}
								?>
