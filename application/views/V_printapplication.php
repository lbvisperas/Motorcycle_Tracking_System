		...
		<div class="col-sm-12">
			<div class="panel panel-primary text-center shadow">
				<div class="panel-heading">
					<div class="row">
						<div class="col-sm-6">
							<h4 class="pull-left ">Generate Application File</h4>
						</div>
					</div>
				</div>
								...
								foreach ($franchise as $row)
								{
									echo "<tr>";
										...
										if ($month1 == "01"){$month1="January";}
											...
											echo "<a href='https://tricyclefranchisingsorsogon.online/ph/index.php/mycontroller/printOverview/$row[franchise_id]' type = 'button' role = 'button' class='btn btn-primary'><span class='glyphicon glyphicon-print'></span>Print</a>";										echo "</td>";
										echo "</tr>";
								}
							?>
							</tbody>
