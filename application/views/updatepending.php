		...
		<div class="col-sm-12">
			<div class="panel panel-primary shadow text-center">
				<div class="panel-heading">
					<div class="row">
						<div class="col-sm-6">
							<h4 class="pull-left ">Pending Franchises</h4>
						</div>
				...
				<div class="panel-body">
					<div class="table-responsive">          
						<table class="table table-stripped table-condensed table-hover" style="margin-bottom: 6px" id="advance-table2">
							<thead>
								<tr>
									<td>
							...
							<?php
								foreach ($franchise as $row)
								{
										...
										if ($row['requirements'] === "Incomplete")
										{
											echo "<tr>";
										...
										echo "<td style='padding-top:12px'>$var</td>";
											...
											echo "<td>";
											echo "<a href='https://tricyclefranchisingsorsogon.online/ph/index.php/mycontroller/checkrequire/$row[franchise_id]' type = 'button' role = 'button' class='btn btn-primary'><span class='glyphicon glyphicon-file'></span> Update Requirements</a>";
											echo "</td>";
											echo "</tr>";
										}
								}
