		...
		<div class="row">
			<div class="col-sm-12">
				<div class="panel panel-primary shadow text-center">
					...
					<div class="row">
							<div class="col-sm-6">
								<h4 class="pull-left ">Search Franchise To Transfer...</h4>
							</div>
					...
					<div class="panel-body">
						<div class="table-responsive">          
							<table class="table table-stripped table-condensed table-hover" style="margin-bottom: 6px" id="advance-table3">
								<thead>
									<tr>
										<td>
								...
								<tbody>
									...
									foreach ($franchise as $row)
									{
										...
										echo "<td>";
										echo "<a style='width:100%' href='https://tricyclefranchisingsorsogon.online/ph/index.php/mycontroller/transfer/$row[franchise_id]' type = 'button' role = 'button' class='btn btn-info'><span class='glyphicon glyphicon-transfer'></span> Transfer</a>";
										echo "</td>";
										echo "</tr>";
									}
									?>
