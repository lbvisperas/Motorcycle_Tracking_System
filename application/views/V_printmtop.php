		...
		<div class="col-sm-12">
			<div class="panel panel-primary text-center shadow">
				<div class="panel-heading">
					<div class="row">
						<div class="col-sm-6">
							<h4 class="pull-left ">Generate Motorized Tricycle Operator's Permit</h4>
						</div>
					</div>
				</div>
								...
								foreach ($franchise as $row)
								{
									echo "<tr>";
										...
										if ($month1 == "01"){$month1="January";}
											...
											echo "<td>";
											echo "<a href='https://tricyclefranchisingsorsogon.online/ph/index.php/mycontroller/C_completeinfo/$row[franchise_id]' type = 'button' role = 'button' class='btn btn-success'><span class='glyphicon glyphicon-search'></span>View</a>";
											echo "<a href='https://tricyclefranchisingsorsogon.online/ph/index.php/mycontroller/printOverview/$row[franchise_id]' type = 'button' role = 'button' class='btn btn-primary'><span class='glyphicon glyphicon-print'></span>Print</a>";
		...
		<div class="col-sm-12">
			<div class="panel panel-primary text-center shadow">
				<div class="panel-heading">
					<div class="row">
						<div class="col-sm-6">
							<h4 class="pull-left ">Manual Mode</h4>
						</div>
					</div>
				</div>
				<div class="panel-body">
					<h4><strong>Please Fill Forms Below: </strong></h4>
				</div>
			</div>
		</div>
	</div>
