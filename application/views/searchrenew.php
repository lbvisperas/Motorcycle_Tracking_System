			...
			<div class="col-sm-12">
				<div class="panel panel-primary shadow text-center">
					<div class="panel-heading">
						<div class="row">
							<div class="col-sm-6">
								<h4 class="pull-left ">Search Franchise To Renew...</h4>
							</div>
						...
						<div class="table-responsive">          
							<table class="table table-stripped table-condensed table-hover" style="margin-bottom: 6px" id="advance-table">
								<thead>
									...
									<td>
										<button style="color:black" type="button" class="btn btn-link btn-md"><b>Time Elapsed Since Expire</b></button>
									</td>
									<td>
										<button style="color:black" type="button" class="btn btn-link btn-md"><b>Association</b></button>
									</td>
									<td>
										<button style="color:black" type="button" class="btn btn-link btn-md"><b>Option</b></button>
									</td>
									</tr>
								</thead>
								<tbody>
									...
									foreach ($franchise as $row)
									{
										...
										$var = $row['time_elapsed_since_expire'];
										$Eday = substr($var, -2);
										$Emonth = substr($var, 3,-3);
										$Eyear = substr($var, 0, -6);
										echo "<td style='padding-top:12px'>$month1 $day1, $year1</td>";
										echo "<td style='padding-top:12px ; color:blue'>$Eyear years, $Emonth months, $Eday days</td>";
										echo "<td style='padding-top:12px'>$row[association_name]</td>";
										echo "<td>";
										echo "<a style='width:100%' href='https://tricyclefranchisingsorsogon.online/ph/index.php/mycontroller/renew/$row[franchise_id]' type = 'button' role = 'button' class='btn btn-primary'><span class='glyphicon glyphicon-refresh'></span> Renew</a>";
										echo "</td>";
										echo "</tr>";
									}
									?>
