		...
		<div class="col-sm-12">
			<div class="panel panel-primary text-center shadow">
				<div class="panel-heading">
					<div class="row">
						<div class="col-sm-6">
							<h4 class="pull-left ">Add Violation Record...</h4>
						</div>
					</div>
				</div>
								...
								foreach ($franchise as $row)
								{
									echo "<tr>";
										...
										if ($month1 == "01"){$month1="January";}
											...
											echo "<td>";
											echo "<a href='https://tricyclefranchisingsorsogon.online/ph/index.php/mycontroller/C_addviolationrecord/$row[franchise_id]' type = 'button' role = 'button' class='btn btn-danger'><span class='glyphicon glyphicon-info-sign'></span> Add Violation Record</a>";
