		...
		<div class="col-sm-12">
			<div class="panel panel-primary text-center shadow">
				<div class="panel-heading">
					<div class="row">
						<div class="col-sm-6">
							<h4 class="pull-left ">Edit Franchise Records...</h4>
						</div>
					</div>
				</div>
								...
								foreach ($franchise as $row)
								{
									echo "<tr>";
										...
										if ($month1 == "01"){$month1="January";}
											...
											echo "<td>";
											echo "<a href='https://tricyclefranchisingsorsogon.online/ph/index.php/mycontroller/C_editfranchiserecord/$row[franchise_id]' type = 'button' role = 'button' class='btn btn-success'><span class='glyphicon glyphicon-edit'></span> Edit Records</a>";
